...
export default function Cart(props) {
  ...
  async function getCartDitails() {
    ...
    if (data) {
      ...
      setCartDeatals(data);
      setCartInfo({ numOfCartItems: data.numOfCartItems, id: data?.data._id });
    }
  }
      ...
      {cartDitals.data ? (
        <div className="container py-5">
          <div className="p-5 mx-auto bg-main-light">
            ...
            <div className="d-flex justify-content-between">
              <h3 className="h5">
                ...
                <span className="text-main">
                  {cartDitals.data.totalCartPrice} EPG
                </span>
              </h3>
              <h3 className="h5">
                Total Cart items :
                <span className="text-main">{cartDitals.numOfCartItems}</span>
              </h3>
            </div>
            {cartDitals.data.products.map((ele) => (
              <div key={ele.product._id} className="row py-5 border-bottom">
                <div className="col-md-1">
                  <img
                    src={ele.product.imageCover}
                    className="w-100"
                    alt={ele.product.imageCover}
                  />
                </div>
                <div className="com-md-11">
                  <div className="d-flex justify-content-between">
                    ...
                    <div className="right-said">
                      <button
                        ...
                        onClick={() =>
                          updatcount(ele.product._id, ele.count - 1)
                        }
                      >
                        -
                      </button>
                  ...
                  <button
                    onClick={() => removeItme(ele.product._id)}
            ...
            <Link
              className="btn bg-main w-100 my-5 text-white"
              to={'/checkout'}
            >
              Checkout
            </Link>
